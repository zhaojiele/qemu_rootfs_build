...
elfs_to_copy="busybox bash ls mount less mkdir hostname cp mv ifconfig \
        ...
        dhclient ln ping ip chown chmod strace systemd stap which \
...
["/etc/passwd", """root::0:0:root:/root:/usr/bin/bash
kenny::1000:1000:KL,,,:/home/kenny:/usr/bin/bash
"""]
]
...
for link in bb_links.split():
	sudo_cmd('ln -sf /usr/bin/busybox '+tr('/bin/'+link))
...
copy_file("/usr/sbin/dhclient-script");
